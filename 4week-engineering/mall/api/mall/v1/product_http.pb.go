...
func RegisterProductServiceHTTPServer(s *http.Server, srv ProductServiceHTTPServer) {
	...
	r.PUT("/v1/product/{id}", _ProductService_UpdateProduct0_HTTP_Handler(srv))
	...
	r.GET("/v1/product/", _ProductService_ListProduct0_HTTP_Handler(srv))
}
...
func _ProductService_CreateProduct0_HTTP_Handler(srv ProductServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/mall.api.v1.ProductService/CreateProduct")
...
func _ProductService_UpdateProduct0_HTTP_Handler(srv ProductServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/mall.api.v1.ProductService/UpdateProduct")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_DeleteProduct0_HTTP_Handler(srv ProductServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/mall.api.v1.ProductService/DeleteProduct")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_GetProduct0_HTTP_Handler(srv ProductServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/mall.api.v1.ProductService/GetProduct")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_ListProduct0_HTTP_Handler(srv ProductServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/mall.api.v1.ProductService/ListProduct")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ProductServiceHTTPClientImpl) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...http.CallOption) (*CreateProductReply, error) {
	...
	opts = append(opts, http.Operation("/mall.api.v1.ProductService/CreateProduct"))
...
func (c *ProductServiceHTTPClientImpl) DeleteProduct(ctx context.Context, in *DeleteProductRequest, opts ...http.CallOption) (*DeleteProductReply, error) {
	...
	opts = append(opts, http.Operation("/mall.api.v1.ProductService/DeleteProduct"))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *ProductServiceHTTPClientImpl) GetProduct(ctx context.Context, in *GetProductRequest, opts ...http.CallOption) (*GetProductReply, error) {
	...
	pattern := "/v1/product/{id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/mall.api.v1.ProductService/GetProduct"))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *ProductServiceHTTPClientImpl) ListProduct(ctx context.Context, in *ListProductRequest, opts ...http.CallOption) (*ListProductReply, error) {
	...
	pattern := "/v1/product/"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation("/mall.api.v1.ProductService/ListProduct"))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ProductServiceHTTPClientImpl) UpdateProduct(ctx context.Context, in *UpdateProductRequest, opts ...http.CallOption) (*UpdateProductReply, error) {
	...
	pattern := "/v1/product/{id}"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation("/mall.api.v1.ProductService/UpdateProduct"))
	opts = append(opts, http.PathTemplate(pattern))
